 ...
 * @brief  ¥ª¥×¥·¥ç¥ó½èÍý
 *
 * ¤³¤³¤Ë¤¢Ž¤¡¦Ø¿ô¤Ï¡Ž¤jconf¥Õ¥¡¥¤Ž¥¡¦ª¤è¤Ó¥³¥Þ¥ó¥É¥é¥¤¥ó¤«¤é¤Î¥ª¥×¥·¥ç¥ó»ØÄê¤¡¦ * ½ç¤ËÆÉ¤ß¹þ¤ß¡¤ÃÍ¤ò³ÊÇ¼¤¹Ž¤¡¦ 
 * </JA>
 * 
 * <EN>
...
/** 
 * <JA>
 * @brief  ŽÁ¡¦Ð¥Ñ¥¹¤ò¥Õ¥¡¦Ñ¥¹¤ËÊÑ´¹¤¹¤¡¦ 
 * 
 * ¥Õ¥¡¥¤Ž¥¡¦Î¥Ñ¥¹Ì¾¤¬Á¡¦Ð¥Ñ¥¹¤Ç¤¢¤¡¦Ð¡¤¥«¥¡¦ó¥È¥Ç¥£¥¡¦¯¥È¥ê¤ò¤Ä¤±¤Ž¿
 * ¥ÕŽ¥¡¦Ñ¥¹¤ËÊÑ´¹¤·¤ÆÊÖ¤Ž¹. ÀäÂÐ¥Ñ¥¹¤Ç¤¢Ž¤¡¦Ð¡¤¤½¤Î¤Þ¤ÞÊÖ¤Ž¹. 
 * 
 * @param filename [in] ¥Õ¥¡¥¤Ž¥¡¦Î¥Ñ¥¹ÌŽ¾
 * @param dirname [in] ¥«Ž¥¡¦ó¥È¥Ç¥£¥¡¦¯¥È¥ê¤Î¥Ñ¥¹ÌŽ¾
 * 
 * @return ÀäÂÐ¥Ñ¥¹Ì¾¤ÎÆþ¤Ã¤¿¡¤¿·¤¿¤Ë³äŽ¤¡¦Õ¤±¤é¤¡¦¿¥Ð¥Ã¥Õ¥Ž¡
 * </JA>
 * <EN>
...
/** 
 * <JA>
 * ¥á¥âŽ¥¡¦Î°è¤ò²òÊ¡¦Ž· NULL ¤ÇËä¤áŽ¤¡¦ 
 * @param p [i/o] ¥á¥âŽ¥¡¦Î°è¤ÎÀèÆ¬¤ò»Ø¤¹¥Ý¥¤¥ó¥¿ÊÑ¿ô¤Ø¤Î¥Ý¥¤¥ó¥Ž¿
 * @note @a p ¤¬ NULL ¤ÎŽ¾¡¦ç¤Ï²¿¤âµ¯¤³¤é¤Ê¤¤¡Ž£
 * </JA>
 * <EN>
 ...
 * ¥ª¥×¥·¥ç¥ó²òÀÏ.
 *
 * @param argc [in] @a argv ¤Ë´Þ¤ÞŽ¤¡¦¡¦ú¿ô¤Î¿¡¦ * @param argv [in] °ú¿ôÃÍ¡ÊÊ¸»úÎó¡Ë¤ÎÇÛŽÎ¡¦ * @param cwd [in] ¥«Ž¥¡¦ó¥È¥Ç¥£¥¡¦¯¥È¥¡¦ * @param jconf [out] ÃÍ¤ò³ÊÇ¼¤¹Ž¤¡¦conf¹½Â¤ÂÎ
 * 
 * </JA>
 * <EN>
 * Option parsing.
...
#define GET_TMPARG  if ((tmparg = next_arg(&i, argc, argv)) == NULL) return FALSE
  ...
  for (i=1;i<argc;i++) {
	...
	jconf->decodeopt.realtime_flag = FALSE;
      } else if (strmatch(tmparg,"memory")) {
	jconf->input.type = INPUT_WAVEFORM;
	jconf->input.speech_input = SP_MEMORY;
	jconf->decodeopt.realtime_flag = FALSE;

...
adin_select(ADIn *a, int source, int dev)
{
  ...
  case SP_MEMORY:
    ...
    a->ad_standby 	   = adin_memory_standby;
    a->ad_begin 	   = adin_memory_begin;
    a->ad_end 		   = adin_memory_end;
    a->ad_resume 	   = NULL;
    a->ad_pause 	   = NULL;
    a->ad_terminate 	   = NULL;
    a->ad_read 		   = adin_memory_read;
    a->ad_input_name	   = adin_memory_get_current_filename;
...
/** 
 * <JA>
 * ²»À¼ÆþÎÏ¥Ç¥Ð¥¤¥¹¤ò½éŽ´¡¦½¤·¡¤²»ÆþÎÏÀÚ½ÐÍÑ¥Ñ¥é¥á¡¼¥¿¤ò¥»¥Ã¥È¥¢¥Ã¥×¤¹¤¡¦ 
 *
 * @param adin [in] AD-in Ž¥¡¦¼¥¯¥¨¥¡¦Ž¢
 * @param jconf [in] Á´ÂÎÀßŽÄ¡¦Ñ¥é¥á¡¼¥Ž¿
 * @param arg [in] ¥Ç¥Ð¥¤¥¹°ÍÂ¸°úŽ¿¡¦ * </JA>
 * <EN>
...
/** 
 * <JA>
 * ÀßŽÄ¡¦Ñ¥é¥á¡¼¥¿¤Ë½¾¤¤²»À¼ÆþÎÏ¥Ç¥Ð¥¤¥¹¤ò¥»¥Ã¥È¥¢¥Ã¥×¤¹¤¡¦ 
 *

...
# endif
  ...
  if (jconf->input.type == INPUT_WAVEFORM) {
    if (jconf->input.speech_input == SP_RAWFILE || jconf->input.speech_input == SP_STDIN || jconf->input.speech_input == SP_ADINNET || jconf->input.speech_input == SP_MEMORY) {
  ...
  if (jconf->input.type == INPUT_WAVEFORM) {
    ...
    if (jconf->preprocess.use_zmean) {
      ...
      if (jconf->input.speech_input == SP_RAWFILE || jconf->input.speech_input == SP_MEMORY) {

...
{
#if defined(HAS_ALSA)
  return(adin_alsa_begin(adinoptTHIS,pathname));
#elif defined(HAS_OSS)
  return(adin_oss_begin(adinoptTHIS,pathname));
#elif defined(HAS_PULSEAUDIO)
  return(adin_pulseaudio_begin(adinoptTHIS,pathname));
#elif defined(HAS_ESD)
  return(adin_esd_begin(adinoptTHIS,pathname));
#else  /* other than Linux */
  jlog("Error: neither of pulseaudio/alsa/oss/esd device is available\n");
  return FALSE;
#endif
...
{
#if defined(HAS_ALSA)
  return(adin_alsa_end(adinoptTHIS));
#elif defined(HAS_OSS)
  return(adin_oss_end(adinoptTHIS));
#elif defined(HAS_PULSEAUDIO)
  return(adin_pulseaudio_end(adinoptTHIS));
#elif defined(HAS_ESD)
  return(adin_esd_end(adinoptTHIS));
#else  /* other than Linux */
  jlog("Error: neither of pulseaudio/alsa/oss/esd device is available\n");
  return FALSE;
#endif
...
{
#if defined(HAS_ALSA)
  return(adin_alsa_read(adinoptTHIS,buf, sampnum));
#elif defined(HAS_OSS)
  return(adin_oss_read(adinoptTHIS,buf, sampnum));
#elif defined(HAS_PULSEAUDIO)
  return(adin_pulseaudio_read(adinoptTHIS,buf, sampnum));
#elif defined(HAS_ESD)
  return(adin_esd_read(adinoptTHIS,buf, sampnum));
#else  /* other than Linux */
  jlog("Error: neither of pulseaudio/alsa/oss/esd device is available\n");
  return -2;
#endif
...
{
#if defined(HAS_ALSA)
  return(adin_alsa_input_name(adinoptTHIS));
#elif defined(HAS_OSS)
  return(adin_oss_input_name(adinoptTHIS));
#elif defined(HAS_PULSEAUDIO)
  return(adin_pulseaudio_input_name(adinoptTHIS));
#elif defined(HAS_ESD)
  return(adin_esd_input_name(adinoptTHIS));
#else  /* other than Linux */

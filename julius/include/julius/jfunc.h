...
int j_recognize_stream_naichichi(Recog *recog);
int j_recognize_mfcc_yobikake(Recog *recog,HTK_Param* mfccparam,unsigned int yobikake_startfream,unsigned int yobikake_endfream);

...
CapeBord_EndelSCommander::CapeBord_EndelSCommander()
{
...
void CapeBord_EndelSCommander::Dump(const unsigned char* src , int size)
{
	printf("\r\n");
...
unsigned char* CapeBord_EndelSCommander::escapeCtrl(const unsigned char* src , unsigned char* dest ,unsigned int size )
{
	const unsigned char * srcP = src;
	const unsigned char * srcEnd = src + size;
...
unsigned char CapeBord_EndelSCommander::calcChecksum(const unsigned char* src,int size)
{
	const unsigned char * srcP = src ;
	const unsigned char * srcEnd = src + size;
	unsigned char sum = 0;
...
const unsigned char* CapeBord_EndelSCommander::unEscapeCtrl(const unsigned char* src , unsigned char* dest ,unsigned int size )
{
	const unsigned char * srcP = src;
	unsigned char * destP = dest;
...
int CapeBord_EndelSCommander::decodePacket(const unsigned char* src ,unsigned char* dest, unsigned short *command)
{
...
int CapeBord_EndelSCommander::encodePacket(const unsigned char* src ,unsigned char* dest, int srclen,unsigned short command)
{
...
int CapeBord_EndelSCommander::transaction(const unsigned char* src ,unsigned char* dest, int srclen,unsigned short command,unsigned short* outCommand)
{
